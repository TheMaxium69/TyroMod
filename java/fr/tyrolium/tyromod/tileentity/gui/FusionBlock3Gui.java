...
public class FusionBlock3Gui extends GuiContainer {
	...
	public FusionBlock3Gui(InventoryPlayer player, TileEntityFusionBlock3 tileentity)
    {
        super(new FusionBlock3Container(player, tileentity));
        this.player = player;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        if(TileEntityFusionBlock3.isBurning(tileentity))
        {
