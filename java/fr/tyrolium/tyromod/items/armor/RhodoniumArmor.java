...
public class RhodoniumArmor extends DefaultArmor implements IHasModel {
    public RhodoniumArmor(String name, ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn, String version, String tier, String id) {
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack armor) {
        ...
        if (player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() instanceof RhodoniumArmor
                && player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() instanceof RhodoniumArmor
