...
public class RecipesMod {
    ...
    public static void init()
    {
        ...
        GameRegistry.addSmelting(new ItemStack(BlocksMod.getBlockCustomClass("bc0")), new ItemStack(ItemsMod.getItemCustomClass("c0")), 1.5F);
        ...
        GameRegistry.addSmelting(new ItemStack(ItemsMod.hoes[6]), new ItemStack(ItemsMod.shovels[16]), 1.5F);
//        GameRegistry.add
    }
