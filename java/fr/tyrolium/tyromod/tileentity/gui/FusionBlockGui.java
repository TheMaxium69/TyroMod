...
public class FusionBlockGui extends GuiContainer {
	...
	public FusionBlockGui(InventoryPlayer player, TileEntityFusionBlock tileentity)
    {
        super(new FusionBlockContainer(player, tileentity));
        this.player = player;
