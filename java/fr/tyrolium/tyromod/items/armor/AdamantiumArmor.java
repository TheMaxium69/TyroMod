...
public class AdamantiumArmor extends DefaultArmor implements IHasModel {
    public AdamantiumArmor(String name, ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn, String version, String tier, String id) {
