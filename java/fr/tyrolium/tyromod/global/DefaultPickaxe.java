...
public class DefaultPickaxe extends ItemPickaxe implements IHasModel {
    private String modVersion;
    private String oreTier;
    private String tyroId;
    public DefaultPickaxe(String name, ToolMaterial materialIn, String version, String tier, String id)
    {
        super(materialIn);
