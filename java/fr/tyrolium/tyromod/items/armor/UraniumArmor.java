...
public class UraniumArmor extends DefaultArmor implements IHasModel {
    public UraniumArmor(String name, ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn, String version, String tier, String id) {
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack armor) {
        ...
        if (player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() instanceof UraniumArmor
                && player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() instanceof UraniumArmor
