...
public class FusionBlock2Gui extends GuiContainer {
	...
	public FusionBlock2Gui(InventoryPlayer player, TileEntityFusionBlock2 tileentity)
    {
        super(new FusionBlock2Container(player, tileentity));
        this.player = player;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        if(TileEntityFusionBlock2.isBurning(tileentity))
        {
