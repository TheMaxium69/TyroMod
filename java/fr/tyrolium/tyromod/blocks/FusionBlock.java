...
public class FusionBlock extends DefaultBlock {
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        ...
        for (int i = 0; i < 4; ++i)
        {
            ...
            worldIn.spawnParticle(EnumParticleTypes.REDSTONE, d0, d1, d2, 2.0D, 1.0D, 0.0D);
        }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if(active) worldIn.setBlockState(pos, BlocksMod.getBlockCustomClass("bc103").getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, true), 3);
        else worldIn.setBlockState(pos, BlocksMod.getBlockCustomClass("bc103").getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, false), 3);
