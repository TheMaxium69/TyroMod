...
public class MaterialsMod {
    ...
    /*TIER 3*/
    public static final ItemArmor.ArmorMaterial ARGONITE_ARMOR = EnumHelper.addArmorMaterial("argonite_armor", Global.MODID + ":argonite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial ASHSTONE_ARMOR = EnumHelper.addArmorMaterial("ashstone_armor", Global.MODID + ":ashstone", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial DROCONITE_ARMOR = EnumHelper.addArmorMaterial("draconite_armor", Global.MODID + ":draconite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial DRAGONSTONE_ARMOR = EnumHelper.addArmorMaterial("dragonstone_armor", Global.MODID + ":dragonstone", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial FYRITE_ARMOR = EnumHelper.addArmorMaterial("fyrite_armor", Global.MODID + ":fyrite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial ILLUMENITE_ARMOR = EnumHelper.addArmorMaterial("illumenite_armor", Global.MODID + ":illumenite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial JADE_ARMOR = EnumHelper.addArmorMaterial("jade_armor", Global.MODID + ":jade", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial MALACHITE_ARMOR = EnumHelper.addArmorMaterial("malachite_armor", Global.MODID + ":malachite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial ONIX_ARMOR = EnumHelper.addArmorMaterial("onix_armor", Global.MODID + ":onix", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial SINISITE_ARMOR = EnumHelper.addArmorMaterial("sinisite_armor", Global.MODID + ":sinisite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial RHODONITE_ARMOR = EnumHelper.addArmorMaterial("rhodonite_armor", Global.MODID + ":rhodonite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial AVENTURINE_ARMOR = EnumHelper.addArmorMaterial("aventurine_armor", Global.MODID + ":aventurine", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial ENDER_ARMOR = EnumHelper.addArmorMaterial("ender_armor", Global.MODID + ":ender", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial GUARDIAN_ARMOR = EnumHelper.addArmorMaterial("guardian_armor", Global.MODID + ":guardian", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial OBSIDIAN_RED_ARMOR = EnumHelper.addArmorMaterial("obsidian_red_armor", Global.MODID + ":obsidian_red", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial TYROLITE_ARMOR = EnumHelper.addArmorMaterial("tyrolite_armor", Global.MODID + ":tyrolite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    ...
    public static final ItemArmor.ArmorMaterial PLATINE_ARMOR = EnumHelper.addArmorMaterial("platine_armor", Global.MODID + ":platine", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial VAPONITE_ARMOR = EnumHelper.addArmorMaterial("vaponite_armor", Global.MODID + ":vaponite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial PROTON_ARMOR = EnumHelper.addArmorMaterial("proton_armor", Global.MODID + ":proton", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial RITONITE_ARMOR = EnumHelper.addArmorMaterial("ritonite_armor", Global.MODID + ":ritonite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial GOLDONITE_ARMOR = EnumHelper.addArmorMaterial("goldonite_armor", Global.MODID + ":goldonite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial OMEGA_ARMOR = EnumHelper.addArmorMaterial("omega_armor", Global.MODID + ":omega", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial URANITE_ARMOR = EnumHelper.addArmorMaterial("uranite_armor", Global.MODID + ":uranite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial PLUTONITE_ARMOR = EnumHelper.addArmorMaterial("plutonite_armor", Global.MODID + ":plutonite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial POLONITE_ARMOR = EnumHelper.addArmorMaterial("polonite_armor", Global.MODID + ":polonite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial CHRONITE_ARMOR = EnumHelper.addArmorMaterial("chronite_armor", Global.MODID + ":chronite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial CORANITE_ARMOR = EnumHelper.addArmorMaterial("coranite_armor", Global.MODID + ":coranite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial MACRONITE_ARMOR = EnumHelper.addArmorMaterial("macronite_armor", Global.MODID + ":macronite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial GALACTITE_ARMOR = EnumHelper.addArmorMaterial("galactite_armor", Global.MODID + ":galactite", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);
    public static final ItemArmor.ArmorMaterial TOPAZ_ARMOR = EnumHelper.addArmorMaterial("topaz_armor", Global.MODID + ":topaz", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0f);

    /*TIER IUM*/
    public static final ItemArmor.ArmorMaterial ADAMANTIUM_ARMOR = EnumHelper.addArmorMaterial("adamantium_armor", Global.MODID + ":adamantium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial VOLCANIUM_ARMOR = EnumHelper.addArmorMaterial("volcanium_armor", Global.MODID + ":volcanium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial COPPERIUM_ARMOR = EnumHelper.addArmorMaterial("copperium_armor", Global.MODID + ":copperium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial PLATINIUM_ARMOR = EnumHelper.addArmorMaterial("platinium_armor", Global.MODID + ":platinium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial NETHERIUM_ARMOR = EnumHelper.addArmorMaterial("netherium_armor", Global.MODID + ":netherium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial CORANIUM_ARMOR = EnumHelper.addArmorMaterial("coranium_armor", Global.MODID + ":coranium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial DRACONIUM_ARMOR = EnumHelper.addArmorMaterial("draconium_armor", Global.MODID + ":draconium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial RHODONIUM_ARMOR = EnumHelper.addArmorMaterial("rhodonium_armor", Global.MODID + ":rhodonium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial AVENTURIUM_ARMOR = EnumHelper.addArmorMaterial("aventurium_armor", Global.MODID + ":aventurium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial VAPORIUM_ARMOR = EnumHelper.addArmorMaterial("vaporium_armor", Global.MODID + ":vaporium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial URANIUM_ARMOR = EnumHelper.addArmorMaterial("uranium_armor", Global.MODID + ":uranium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial MACRONIUM_ARMOR = EnumHelper.addArmorMaterial("macronium_armor", Global.MODID + ":macronium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial STEELIUM_ARMOR = EnumHelper.addArmorMaterial("steelium_armor", Global.MODID + ":steelium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial YELLORIUM_ARMOR = EnumHelper.addArmorMaterial("yellorium_armor", Global.MODID + ":yellorium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial TITANIUM_ARMOR = EnumHelper.addArmorMaterial("titanium_armor", Global.MODID + ":titanium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial RITONIUM_ARMOR = EnumHelper.addArmorMaterial("ritonium_armor", Global.MODID + ":ritonium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial PLUTONIUM_ARMOR = EnumHelper.addArmorMaterial("plutonium_armor", Global.MODID + ":plutonium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial PROTONIUM_ARMOR = EnumHelper.addArmorMaterial("protonium_armor", Global.MODID + ":protonium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial THYRIUM_ARMOR = EnumHelper.addArmorMaterial("thyrium_armor", Global.MODID + ":thyrium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial OBSIDIUM_ARMOR = EnumHelper.addArmorMaterial("obsidium_armor", Global.MODID + ":obsidium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial SAPPHIRIUM_ARMOR = EnumHelper.addArmorMaterial("sapphirium_armor", Global.MODID + ":sapphirium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial GOLDONIUM_ARMOR = EnumHelper.addArmorMaterial("goldonium_armor", Global.MODID + ":goldonium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial POLONIUM_ARMOR = EnumHelper.addArmorMaterial("polonium_armor", Global.MODID + ":polonium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial SILVERIUM_ARMOR = EnumHelper.addArmorMaterial("silverium_armor", Global.MODID + ":silverium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial TYROLIUM_ARMOR = EnumHelper.addArmorMaterial("tyrolium_armor", Global.MODID + ":tyrolium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial ENDERIUM_ARMOR = EnumHelper.addArmorMaterial("enderium_armor", Global.MODID + ":enderium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial MERCURIUM_ARMOR = EnumHelper.addArmorMaterial("mercurium_armor", Global.MODID + ":mercurium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial OMEGANIUM_ARMOR = EnumHelper.addArmorMaterial("omeganium_armor", Global.MODID + ":omeganium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial CHROMITIUM_ARMOR = EnumHelper.addArmorMaterial("chromitium_armor", Global.MODID + ":chromitium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
    public static final ItemArmor.ArmorMaterial SILICIUM_ARMOR = EnumHelper.addArmorMaterial("silicium_armor", Global.MODID + ":silicium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);

    /*TIER ULTIME*/
    public static final ItemArmor.ArmorMaterial ULTIUM_ARMOR = EnumHelper.addArmorMaterial("ultium_armor", Global.MODID + ":ultium", 20, new int[] {7, 8, 8, 9}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0f);
