...
public class FusionBlock2 extends DefaultBlock {
    ...
    public FusionBlock2(String name, Material materialIn, String version, String id) {
...
//    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if(!worldIn.isRemote)
        {
            playerIn.openGui(TyroMod.instance, Global.GUI_FUSION_BLOCK2, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
