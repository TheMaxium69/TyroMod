...
public class TyroliumCommandBlock extends BlockCommandBlock implements IHasModel {
    private Boolean isOre;
    private String modVersion;
    private String oreTier;
    private String tyroId;

    public TyroliumCommandBlock(String name, Material materialIn, String version, String id) {
