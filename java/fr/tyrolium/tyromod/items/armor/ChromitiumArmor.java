...
public class ChromitiumArmor extends DefaultArmor implements IHasModel {
    public ChromitiumArmor(String name, ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn, String version, String tier, String id) {
