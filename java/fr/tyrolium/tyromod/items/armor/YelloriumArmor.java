...
public class YelloriumArmor extends DefaultArmor implements IHasModel {
    public YelloriumArmor(String name, ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn, String version, String tier, String id) {
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack armor) {
        ...
        if (player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() instanceof YelloriumArmor
                && player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() instanceof YelloriumArmor
