...
public class FusionBlock3Container extends Container
{
    private final TileEntityFusionBlock3 tileentity;
    private int cookTime, totalCookTime, burnTime, currentBurnTime;

    public FusionBlock3Container(InventoryPlayer player, TileEntityFusionBlock3 tileentity)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if(slot != null && slot.getHasStack())
        {
            ...
            else if(index != 2 && index != 1 && index != 0)
            {
                ...
                if(!FusionBlock3Recipes.getInstance().getSinteringResult(stack1, slot1.getStack()).isEmpty())
                {
                    if(!this.mergeItemStack(stack1, 0, 2, false))
                    {
                        return ItemStack.EMPTY;
                    }
                    else if(TileEntityFusionBlock3.isItemFuel(stack1))
                    {
