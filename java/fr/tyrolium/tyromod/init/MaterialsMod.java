...
public class MaterialsMod {
    ...
    public static final Item.ToolMaterial THYRIUM_HAMMER = EnumHelper.addToolMaterial("thyrium_hammer", 2, 400, 3.0f, 5.0f, 20);
    ...
    public static final Item.ToolMaterial TITANIUM_HAMMER = EnumHelper.addToolMaterial("titanium_hammer", 2, 400, 3.0f, 5.0f, 20);
